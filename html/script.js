...
(function (global, jQuery, TAR) {
    ...
    planeMan.refresh = function () {
        ...
        jQuery("#current_time").updateText(
            ...
            + "   " + new Date().toLocaleTimeString('en-US', {hour: '2-digit', minute: '2-digit', hour12: false}) + " loc"
        );
...
function drawOutlineJson() {
    ...
    let points = [
        [40.779710, -119.237421], // P1-
        [40.803523, -119.221409], // P2-
        [40.799290, -119.186670], // P3-
        [40.772883, -119.181237], // P4-
        [40.760786, -119.212582], // P5
    ];
    addOutline(points);
            cache: false,
    // frog pond
    ...
    // runways
    points = [
      [40.76583, -119.18915], //23L
      [40.75882, -119.20875], //5R
    ];
    addOutline(points);

    points = [
      [40.75881, -119.21641], //23R
      [40.75179, -119.23601],  //5L
    ];
    addOutline(points);
